 ...
 *
 * <p>You can use {@link #initiateScan(android.app.Activity, CharSequence, CharSequence, CharSequence, CharSequence)} or
 * {@link #initiateScan(android.app.Activity, int, int, int, int)} to customize the download prompt with
 * different text labels.</p>
 *
 * <p>Note that {@link #initiateScan(android.app.Activity)} returns an {@link android.app.AlertDialog} which is non-null if the
...
public final class IntentIntegrator {
    ...
    /**
     * See {@link #initiateScan(android.app.Activity, CharSequence, CharSequence, CharSequence, CharSequence)} --
     ...
     * to the {@link android.app.Activity}'s resource bundle entries.
     */
    public static AlertDialog initiateScan(Activity activity,
                                           int stringTitle,
                                           int stringMessage,
    ...
    /**
     * See {@link #initiateScan(android.app.Activity, CharSequence, CharSequence, CharSequence, CharSequence, CharSequence)} --
     ...
     * @return an {@link android.app.AlertDialog} if the user was prompted to download the app,
     *  null otherwise
     */
    public static AlertDialog initiateScan(Activity activity,
    ...
    /**
     * See {@link #shareText(android.app.Activity, CharSequence, CharSequence, CharSequence, CharSequence, CharSequence)} --
     * same, but uses default English labels.
     */
    ...
    /**
     * See {@link #shareText(android.app.Activity, CharSequence, CharSequence, CharSequence, CharSequence, CharSequence)} --
     * same, but takes string IDs which refer to the {@link android.app.Activity}'s resource bundle entries.
     */
